...
bool TextClass::Initialize(ID3D11Device* device, ID3D11DeviceContext* deviceContext, int screenWidth, int screenHeight, int maxLength, 
						   bool shadow, FontClass* Font, LPCWSTR text, int positionX, int positionY, float red, float green, float blue)
{
	bool result;
...
bool TextClass::InitializeSentence(ID3D11Device* device, ID3D11DeviceContext* deviceContext, FontClass* Font, LPCWSTR text, int positionX,
...
bool TextClass::UpdateSentence(ID3D11DeviceContext* deviceContext, FontClass* Font, LPCWSTR text, int positionX, int positionY, float red,
							   float green, float blue)
{
	...
	numLetters = (int)strlen((char*)(text));
