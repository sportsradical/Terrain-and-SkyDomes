...
bool FontClass::Initialize(ID3D11Device* device, ID3D11DeviceContext* deviceContext, LPCWSTR fontFilename, LPCWSTR textureFilename,
...
bool FontClass::LoadTexture(ID3D11Device* device, ID3D11DeviceContext* deviceContext, LPCWSTR filename)
{
	bool result;
...
void FontClass::BuildVertexArray(void* vertices, LPCWSTR sentence, float drawX, float drawY)
{
	...
	numLetters = (int)strlen((char*)(sentence));
